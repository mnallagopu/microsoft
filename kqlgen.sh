...
echo "************"
seq 1 | xargs -Iz echo "--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--"
echo -e "\nSTEP:2) PLEASE SELECT THE VALUE OF THE TIMELINETYPE TYPE"
echo -e "\na-ago (default is 3 days) \nb-time_between (default is ${CDATE}T${CTIME}Z - ${C3DATE}T${CTIME}Z )"
echo "************"
read -p "Type of Timeline : "  TIMELINETYPE
echo "************"
seq 1 | xargs -Iz echo "--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--/--"
echo -e "\nSTEP:3) PLEASE SELECT THE RESOURCE URI"
echo "************"
...
then
	...
	cluster(\"aks\").database(\"AKSprod\").BlackboxMonitoringActivity
	| where PreciseTimeStamp $TIMEVALUE and underlayName == \"\"
	| where reason != \"\"
	...
	| where PreciseTimeStamp $TIMEVALUE // between (datetime(2018-07-16) .. datetime(2018-07-20))
